...
class InferenceDataset:
    ...
    def __init__(self, config, ref_dataset, trg_datast, model, config_model, hd_model=None, val_set=None):
        ...
        self.n_label = self.ref_dataset.get_n_label() #HD trg_datast
        self.model = model 
    ...
    def compute_results(self, file_list=None, seq=None):
    ...
    def compute_dataset_vis(self,i=0):
        if i < len(self.trg_datast.sequence):
            self.compute_sequence(i)
